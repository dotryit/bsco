...
import ch.feol.bsco.building.MeasuredSimulation;
import ch.feol.bsco.clock.Clock;
import ch.feol.bsco.quantity.Power;

public class SingleTariffSurplusManagerMeasuredSimulator {

   private static final Logger LOG;

   static {
      System.setProperty("org.slf4j.simpleLogger.defaultLogLevel", "info");
      LOG = LoggerFactory.getLogger(SingleTariffSurplusManagerMeasuredSimulator.class);
   }
